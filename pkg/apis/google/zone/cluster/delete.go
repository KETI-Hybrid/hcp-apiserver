...
func (DeleteResource) Uri() string {
	return "/gke/zone/cluster/delete"
}
...
func (DeleteResource) Delete(rw http.ResponseWriter, r *http.Request, ps httprouter.Params) apis.Response {
	...
	resp, err := containerService.Projects.Zones.Clusters.Delete(inputRequest.ProjectName, inputRequest.LocationName, inputRequest.ClusterName).Context(ctx).Do()
	if err != nil {
		klog.Errorln(err)
	}
