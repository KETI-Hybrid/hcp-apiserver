...
func (SetResourceLabelsResource) Post(rw http.ResponseWriter, r *http.Request, ps httprouter.Params) apis.Response {
	...
	inputRequest := &SetResourceLabels{}
	...
	resp, err := containerService.Projects.Locations.Clusters.SetResourceLabels(name, realRequest).Context(ctx).Do()
	if err != nil {
		klog.Errorln(err)
	}
