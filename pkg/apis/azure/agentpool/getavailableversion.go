...
func (GetAvailableAgentPoolVersionsResource) Get(rw http.ResponseWriter, r *http.Request, ps httprouter.Params) apis.Response {
	...
	inputRequest := &GetAvailableAgentPoolVersions{}
	...
	result, err := AgentPoolsClient.GetAvailableAgentPoolVersions(ctx, inputRequest.ResourceGroupName, inputRequest.ClusterName, nil)
	if err != nil {
		klog.Errorln(err)
	}
