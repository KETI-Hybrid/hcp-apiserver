...
func (ListByResourceGroupResource) Get(rw http.ResponseWriter, r *http.Request, ps httprouter.Params) apis.Response {
	...
	inputRequest := &ListByResourceGroup{}
	...
	items := ManagedClustersClient.NewListByResourceGroupPager(inputRequest.ResourceGroupName, nil)
	result := make([]armcontainerservice.ManagedClustersClientListByResourceGroupResponse, 0)
	for items.More() {
