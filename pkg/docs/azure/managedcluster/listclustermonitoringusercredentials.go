...
func (ListClusterMonitoringUserCredentialsResource) Post(rw http.ResponseWriter, r *http.Request, ps httprouter.Params) docs.Response {
	t := reflect.TypeOf(ListClusterMonitoringUserCredentials{})
	...
	t2 := reflect.TypeOf(armcontainerservice.ManagedClustersClientListClusterMonitoringUserCredentialsResponse{})
